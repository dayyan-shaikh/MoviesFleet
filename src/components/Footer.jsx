...
const Footer = () => {
  return (
    <div>
      <footer classNameName="flex flex-col items-center bg-zinc-50 text-center text-surface dark:bg-neutral-700 dark:text-white">
        ...
        <div className="w-full bg-black/5 p-4 text-center white">
          © 2024 Copyright
        </div>
      </footer>
    </div>
